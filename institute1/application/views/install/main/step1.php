...
$autoload_file_write_perm = is_writable('application/config/autoload.php');
$routes_file_write_perm   = is_writable('application/config/routes.php');
$curl_enabled             = function_exists('curl_version');
if ($db_file_write_perm == false || $autoload_file_write_perm == false || $routes_file_write_perm == false || $curl_enabled == false) {
    $valid = false;
} else {
    $valid = true;
}
            ...
            <div class="card-body">
                <div class="panel panel-default" data-collapsed="0"
                    ...
                    <div class="panel-body" style="font-size: 14px;">
                        ...
                        <br>
                        <p style="font-size: 14px;">
                            <?php if ($autoload_file_write_perm == true) { ?>
                                <i class="dripicons-checkmark" style="color: #5ac52d;"></i>
                            <?php } else { ?>
                                <i class="dripicons-cross" style="color: #f12828"></i>
                            <?php } ?>
                            <strong>application/config/autoload.php </strong>: file has write permission
                        </p>
