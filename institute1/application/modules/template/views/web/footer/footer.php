    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-lg-3 col-sm-6 col-xs-12 wow fadeInUp" data-wow-delay="0.2s">
                <h3><img height="28px" width="189px" src="web_assets/img/gcwuf.png" alt=""></h3>
                <p>
                    Aorem ipsum dolor sit amet elit sed lum tempor incididunt ut labore el dolore alg minim veniam quis
                    nostrud ncididunt.
                </p>
            </div>
                ...
                <ul class="image-list">
                    <li>
                        <figure class="overlay">
                            <img class="img-fluid" src="web_assets/img/art/a1.jpg" alt="">
                        </figure>
                    ...
                    <li>
                        <figure class="overlay">
                            <img class="img-fluid" src="web_assets/img/art/a2.jpg" alt="">
                        </figure>
                        <div class="post-content">
                            <h6 class="post-title"><a href="blog-single.html">Lorem ipsm dolor sumit.</a></h6>
                            <div class="meta"><span class="date">October 12, 2018</span></div>
