            ...
            <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
                <div class="accordion">
                    <?php if (!empty($faqs)) {
                        foreach ($faqs as $faq) { ?>
                            <div class="card">
                                <div class="card-header" id="headingOne_<?php echo $faq->id ?>">
                                    <div class="header-title" data-toggle="collapse"
                                         data-target="#question<?php echo $faq->id ?>"
                                         aria-expanded="true" aria-controls="collapseOne">
                                        <i class="lni-pencil"></i> <?php echo $faq->question ?>
                                    </div>
                                </div>
                                <div id="question<?php echo $faq->id ?>" class="collapse"
                                     aria-labelledby="headingOne_<?php echo $faq->id ?>"
                                     data-parent="#question_">
                                    <div class="card-body">
                                        <?php echo $faq->answer ?>
                                    </div>
                                </div>
