        ...
        <div class="row">
            <div class="col-12">
                <div class="section-title-header text-center">
                    ...
                    <p class="wow fadeInDown" data-wow-delay="0.2s">Lorem ipsum dolor sit amet, consectetur adipiscing
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <?php if (!empty($events)) {
                            ...
                            foreach ($events as $event) { ?>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link <?php if ($i == 1) echo ' active ' ?>" id="monday-tab"
                                       data-toggle="tab" href="#tab_id_<?php echo $event->id ?>"
                                       role="tab"
                                       aria-controls="monday" aria-expanded="true"

                                    >
                                        <div class="item-text">
                                            <h4><?php echo date('l', strtotime($event->date)) ?></h4>
                                            <h5><?php echo date('d F', strtotime($event->date)) ?></h5>
                                        </div>
                                    </a>
                                </li>
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    foreach ($events as $event) {
                        ...
                        <div class="tab-pane fade <?php if ($i == 1) echo ' show active '; ?>"
                             id="tab_id_<?php echo $event->id ?>" role="tabpanel" aria-labelledby="monday-tab">
                            <div id="accordion">
                                <div class="card">
                                    <div id="headingOne">
                                        <div class="collapsed card-header" data-toggle="collapse"
                                            ...
                                            <div class="images-box">
                                                <img class="img-fluid" style="height: 70px" src="<?php echo $event->img ?>"
                                                     alt="">
                                            </div>
                                ...
                                <div class="card">
                                    <div id="headingTwo">
                                        <div class="collapsed card-header" data-toggle="collapse"
                                            ...
                                            <div class="images-box">
                                                <img class="img-fluid" src="web_assets/img/speaker/speakers-2.jpg"
                                                     alt="">
                                            </div>
                                ...
                                <div class="card">
                                    <div id="headingThree">
                                        <div class="collapsed card-header" data-toggle="collapse"
                                            ...
                                            <div class="images-box">
                                                <img class="img-fluid" src="web_assets/img/speaker/speakers-3.jpg"
                                                     alt="">
                                            </div>
                                            <span class="time">10am - 12:30pm</span>
                            ...
                            <div class="card">
                                <div id="headingOne1">
                                    <div class="collapsed card-header" data-toggle="collapse"
                                        ...
                                        <div class="images-box">
                                            <img class="img-fluid" src="web_assets/img/speaker/speakers-1.jpg" alt="">
                                        </div>
                                        <span class="time">10am - 12:30pm</span>
                            ...
                            <div class="card">
                                <div id="headingTwo2">
                                    <div class="collapsed card-header" data-toggle="collapse"
                                        ...
                                        <div class="images-box">
                                            <img class="img-fluid" src="web_assets/img/speaker/speakers-2.jpg" alt="">
                                        </div>
                                        <span class="time">10am - 12:30pm</span>
                                        <h4>Web Design Principles and Best Practices</h4>
                                        <h5 class="name">David Warner</h5>
                            ...
                            <div class="card">
                                <div id="headingThree3">
                                    <div class="collapsed card-header" data-toggle="collapse"
                                        ...
                                        <div class="images-box">
                                            <img class="img-fluid" src="web_assets/img/speaker/speakers-3.jpg" alt="">
                                        </div>
                                        <span class="time">10am - 12:30pm</span>
                                        <h4>Web Design Principles and Best Practices</h4>
                                        <h5 class="name">David Warner</h5>
