...
<head>
    ...
    <link href="login1/css/login.css" rel="stylesheet"
          type="text/css"/>

    <!--begin::Global Theme Styles(used by all pages)-->
    <link href="login1/css/plugins.bundle.css"
          rel="stylesheet" type="text/css"/>
    <link href="login1/css/prismjs.bundle.css"
          rel="stylesheet" type="text/css"/>
    <link href="login1/css/style.bundle.css" rel="stylesheet"
          type="text/css"/>
    <!--end::Global Theme Styles-->

    <!--begin::Layout Themes(used by all pages)-->

    <!--    <link href="login1/css/light.css"-->
    <!--          rel="stylesheet" type="text/css"/>-->
...
<div class="d-flex flex-column flex-root">
    ...
    <div class="login login-4 login-signin-on d-flex flex-column flex-lg-row flex-row-fluid bg-white" id="kt_login">
        ...
        <div class="order-2 order-lg-1 flex-column-auto flex-lg-row-fluid d-flex flex-column p-7"
             style="background-image: url(login1/img/bg2.jpeg);background-size: cover">
            <!--begin::Content body-->
...
<script src="login1/js/plugins.bundle.js"></script>
<script src="login1/js/prismjs"></script>
<script src="login1/js/scripts.bundle.js"></script>
<!--end::Global Theme Bundle-->


<!--begin::Page Scripts(used by this page)-->
<script src="login1/js/login.js"></script>
<!--end::Page Scripts-->
</body>
<!--end::Body-->
</html>
