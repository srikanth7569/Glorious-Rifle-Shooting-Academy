...
//        $this->load->helper("url");
    ...
    public function subscribe()
    {
        ...
        if (!empty($_POST["plan_name"]) && !empty($_POST["plan_description"])) {
            ...
            $returnurl = base_url() . "frontend/payment/success";
            $cancelurl = base_url() . "frontend/payment/cancel";
    ...
    public function create_payment()
    {
        ...
        $return_url     = base_url() . "frontend/payment/success_payment";
        $cancel_url     = base_url() . "frontend/payment/cancel";
        $total          = getPost('event_price');
        $description    = "Paypal Event payment";
        $intent         = "sale";
