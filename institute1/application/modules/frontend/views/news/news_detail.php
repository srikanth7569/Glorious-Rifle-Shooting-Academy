            ...
            <div class="col-md-9">
                ...
                <header class="entry-header">
                    ...
                    <ul class="entry-meta">
                        ...
                        <li class="entry-date">
                            <span>Date</span>
                            <span class="value"> <?php echo date('Y-m-d', strtotime($newsDetail->created_at)) ?></span>
                        </li>
                    </ul>
                </header>
                ...
                <div class='post-wrapper'>
                    <a class="post-image" href="javascript:void(0)">
                        <img width="870" height="445" src="<?php echo $newsDetail->img ?>"
                             alt=""/>
                    </a>
                </div>
